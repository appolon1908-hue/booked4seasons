...
export function Footer() {
  return <footer className="site-footer">
    ...
    <div className="container copyright"><span>© 2026 {legal.operator}.</span><Link href={legal.policies.privacy}>Privacy</Link><Link href={legal.policies.terms}>Terms</Link><Link href={legal.policies.refunds}>Refunds & returns</Link><Link href={legal.policies.cancellations}>Cancellations</Link><Link href={legal.policies.fulfillment}>Service fulfillment</Link></div>
  </footer>;
}
