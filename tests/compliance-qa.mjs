...
for(const route of ["\/contact","\/become-a-pro"]) assert.match(chat,new RegExp(route.replaceAll("/","\\/")),`chat exclusion missing ${route}`);
assert.doesNotMatch(chat,/phoneFormRoutes[^;]*request-service/);
